<x-app-layout>
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            ...
            <!-- Edit an Example -->
            <h1 class=" text-3xl mt-3 text-gray-500">Edit an example</h1>

            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                <!-- Edit Form -->
                <form action="{{ route('example.update', ['example' => $example->id]) }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="inline-flex mt-2 mb-2">
                        ...
                        <input type="radio" name="show" id="show" value="1" @checked($example->show == 1)>
                    </div>
                    <br>
                    ...
                    <div class="inline-flex mt-2 mb-2">
                        ...
                        <input type="radio" name="show" id="hide" value="0" @checked($example->show == 0)>
                    </div>
                    <hr>
                    ...
                    <select name="status" id="status"
                        ...
                        <option value="enable" @selected($example->status == 'enable')>Enable</option>
                        <option value="disable" @selected($example->status == 'disable')>Disable</option>
                    </select>
                    <hr>
